...
namespace World
{
    ...
    {
        public const int ScanPadding = 3;
        ...
        public void Start()
        {
            ...
            ScanRangeHorizontal = Mathf.CeilToInt(screenDimensions.x / Chunk.ChunkSize) + ScanPadding;
            ScanRangeVertical = Mathf.CeilToInt(screenDimensions.y / Chunk.ChunkSize) + ScanPadding;
        }
        [SubscribeEvent]
        ...
        private void Scan()
        {
            ...
            for(int x = -ScanRangeHorizontal; x < ScanRangeHorizontal; x++)
            {
                ...
                {
                    Vector2Int chunkPosition = WorldQuery.FindNearestChunkPosition(localPlayer.Position + new Vector2Int(x, y));
