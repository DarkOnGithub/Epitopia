...
//         }
//         private void AddNoiseNode(MemberInfo info)
//         {
//             var graph = NodeEditorWindow.current.graph;
//             NodeFactory.CreateNoiseNode(graph, info, NodeEditorWindow.current.WindowToGridPosition(Event.current.mousePosition));
//         }
...
//                 _allNodesInfos.Add((new GUIContent($"Nodes/{declaringType}/{node.Name}"), false, () => AddNoiseNode(node), node));
//             }
//         }
//     }
// }